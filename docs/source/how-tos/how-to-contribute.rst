...
.. _bug: https://github.com/imAsparky/django-cookiecutter/issues

Fix Bugs
~~~~~~~~

Look through Django Cookiecutter GitHub issues_ for bugs.
...
Look through Django Cookiecutter GitHub issues_ for features.
...
Django Cookiecutter provides the four pillars Tutorials, How-to, Reference and
...
Django Cookiecutter uses Sphinx to document the API.  Class's, modules, or
...
an `Issue <https://github.com/imAsparky/django-cookiecutter/issues>`_.
...
Here's how to set up `django-cookiecutter` for local development. We have
...
2. From your GitHub account, fork the `django-cookiecutter` repository.
...
.. _issues: https://github.com/imAsparky/django-cookiecutter/issues
